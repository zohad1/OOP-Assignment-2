...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Size = System::Drawing::Size(241, 25);
			this->label1->TabIndex = 0;
			this->label1->Text = L"  TIMETABLE SYSTEM";
			this->label1->Click += gcnew System::EventHandler(this, &MainForm::label1_Click);
			// 
			// btnviewtimetable
			// 
			this->btnviewtimetable->BackColor = System::Drawing::Color::Black;
			...
			this->btnviewtimetable->Location = System::Drawing::Point(158, 144);
			...
			// btnteachertimetable
			// 
			this->btnteachertimetable->BackColor = System::Drawing::Color::Black;
			this->btnteachertimetable->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10.2F, System::Drawing::FontStyle::Regular,
				System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(0)));
			this->btnteachertimetable->ForeColor = System::Drawing::Color::White;
			this->btnteachertimetable->Location = System::Drawing::Point(158, 240);
			...
			this->btnteachertimetable->UseVisualStyleBackColor = false;
			...
			this->button1->Location = System::Drawing::Point(158, 325);
			...
			this->button3->Location = System::Drawing::Point(502, 425);
			...
			this->button4->Location = System::Drawing::Point(502, 325);
			...
			this->button5->Location = System::Drawing::Point(502, 240);
			...
			this->button6->Location = System::Drawing::Point(502, 144);
			...
			this->panel1->Size = System::Drawing::Size(795, 2);
...
#pragma endregion
	...
	private: System::Void MainForm_Load(System::Object^ sender, System::EventArgs^ e) {
		   ...
		   void GenerateRandomTimetable()
		   {
			   ...
			   array<String^>^ subjects = ReadFromFile("D:/Course.txt");
			   array<String^>^ teachers = ReadFromFile("D:/Teacher.txt"); // Assume only teacher names are in this file
			   array<String^>^ rooms = ReadFromFile("D:/Room.txt");
